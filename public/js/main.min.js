...
(function() {
    ...
    video.addEventListener('loadedmetadata', function() {
        ...
        function updateVideo() {
            // Calculate scroll progress based on page scroll, not just hero section
            // This makes the animation span ~2 screen heights worth of scrolling
            const scrollTop = window.pageYOffset || document.documentElement.scrollTop;
            const animationDistance = window.innerHeight * 2; // Animation completes after 2 screen heights
    ...
    // Also add a canplaythrough listener
