...
(function() {
    ...
    function unlockAudio() {
        ...
        if (playPromise !== undefined) {
            playPromise.then(() => {
                ...
                // Hide the sound enable overlay
                const overlay = document.getElementById('soundEnableOverlay');
                if (overlay) {
    ...
    // Sound enable overlay click handler
    const soundOverlay = document.getElementById('soundEnableOverlay');
    if (soundOverlay) {
