...
(function() {
    ...
    function initScrollAnimation() {
        ...
        function updateAnimation() {
            ...
            // Play sound at 75% completion
            if (scrollProgress >= 0.75 && !soundPlayed) {
                if (sound) {
                    console.log('🔊 Attempting to play sound at frame', frameIndex);
                    console.log('Sound readyState:', sound.readyState, 'currentSrc:', sound.currentSrc);
                    ...
                    sound.play()
                        ...
                        .catch(e => {
                            console.error('❌ Audio blocked:', e.message);
                            console.log('💡 Try clicking on the page first to enable audio');
                        });
                } else {
                    console.error('Sound element is null!');
                }
                soundPlayed = true;
            }
