    ...
    function initScrollAnimation() {
        ...
        function updateAnimation() {
            ...
            if (heroSection) {
                ...
                // Play sound at 95% of hero section scroll (when user is further down page)
                if (soundScrollProgress >= 0.95 && !soundPlayed && sound) {
                    console.log('🔊 Playing sound! Hero section at:', soundScrollProgress.toFixed(2));
