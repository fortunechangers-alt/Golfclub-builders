...
(function() {
    ...
    function initScrollAnimation() {
        ...
        function updateAnimation() {
            ...
            // USE HERO SECTION POSITION FOR SOUND (like the old working code)
            const heroSection = document.querySelector('.hero');
            if (heroSection) {
                const rect = heroSection.getBoundingClientRect();
                const soundScrollProgress = Math.max(0, Math.min(1, 1 - (rect.bottom / (window.innerHeight + rect.height))));
                
                // Play sound at 80% of hero section scroll (earlier trigger)
                console.log('Hero section progress:', soundScrollProgress.toFixed(2));
                if (soundScrollProgress >= 0.80 && !soundPlayed && sound) {
                    console.log('🔊 TRIGGERING SOUND! Hero section at:', soundScrollProgress.toFixed(2));
