...
<section class="parallax-section" style="position: relative; height: 60vh; min-height: 400px; overflow: hidden; margin-top: 120px;">
    ...
    <div class="parallax-bg" style="position: absolute; top: 0; left: 0; width: 100%; height: 120%; background-image: url('<?= base_url('images/golf-course-parallax.webp') ?>'); background-size: cover; background-position: 10% 70%; background-attachment: fixed; will-change: transform;"></div>
